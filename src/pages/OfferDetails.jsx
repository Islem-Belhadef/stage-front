...
import { ExportSquare, Timer1, Calendar,Briefcase } from "iconsax-react"
    ...
    return (
        <div className="bg-gray-50">
          {/* <Header fontColor="#272937" bgColor="#FFFFFF" btnColor="#383EBE" /> */}
            ...
            <div className="flex flex-col bg-white rounded-xl shadow-md shadow-gray-100  h-fit md:mx-16 my-6">
                <div className=" headercont flex gap-12 pt-6 pb-2 px-10  border-b border-gray-20 border-solid ">
                    <div
                ...
                <div className=" bodycont flex flex-col px-11 pt-8 py-10">
                    <div className="titleandbuttons flex items-center justify-between">
                        ...
                        <div className="buttons flex items-center gap-6">
                            ...
                            />
                            <button className="primary-btn w-44 hidden sm:block"
                    ...
                    <div className="discription">
                        <h2 className="font-body text-text text-xl font-bold ">Internship description</h2>
                        <p className="font-body text-graytext mt-8">
            ...
            {showApplyModal && <ApplyModal company={thisOffer.company.name} setshowApplyModal={setshowApplyModal} setshowSuccessModal={setshowSuccessModal}/>}
